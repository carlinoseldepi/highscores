...
class ScoresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create score" do
    assert_difference('Score.count') do
      post scores_url, params: { score: { game_id: @score.game_id, player_email: @score.player_email, score: @score.score } }
    end
  ...
  test "should update score" do
    patch score_url(@score), params: { score: { game_id: @score.game_id, player_email: @score.player_email, score: @score.score } }
